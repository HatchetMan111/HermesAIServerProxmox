...
echo -e "${INFO}${YW} Provider EINMAL einrichten (WebUI-Onboarding oder im Container):${CL}"
echo -e "${TAB}${BGN}hermes-setup  (danach: systemctl restart hermes-webui)${CL}"
